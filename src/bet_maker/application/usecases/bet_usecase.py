...
async def make_bet(
    gateway: BetGateway, event_client: EventClient, bet_sum: Decimal, event_id: str
) -> int:
...
async def update_bet_state_if_event_state_was_updated(
    gateway: BetGateway, event: Event
) -> None:
